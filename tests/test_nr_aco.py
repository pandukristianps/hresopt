...
def test_nr_aco():
    ...
    for run in range(N_RUNS):
        ...
        all_history_best.append(history_best[:, 3])  # LCOE only
    ...
    df_conv.to_csv("results_nr_aco_convergence.csv", index=False)

    print("\nResults saved to results_nr_aco_convergence.csv")
