...
def test_pso():
    ...
    for run in range(N_RUNS):
        ...
        all_history_best.append(history_best[:, 4])
    ...
    # POST-PROCESS
    # =========================================================
    all_history_best = np.array(all_history_best) 
    ...
    print(f"Geothermal: {best_config[2]}")
    ...
    df_conv.to_csv("results_pso_convergence.csv", index=False)

    print("\nResults saved to results_pso_convergence.csv")
