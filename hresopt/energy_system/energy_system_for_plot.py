...
def simulate_energy_system(
    ...
    installed_capacity = num_wind * equip.P_rated_wind + num_wave * equip.P_rated_wave
    ...
    return {
        ...
        "SOC_ts": SOC,
        "energy_met_ts": energy_met,
        "energy_demand_ts": energy_demand,
        "energy_met_ratio_ts": energy_met_ratio
    }